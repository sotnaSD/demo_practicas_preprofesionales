 ...
 *   https://datatables.net/download/#bs4/dt-1.10.20/af-2.3.4/b-1.6.1/b-colvis-1.6.1/b-flash-1.6.1/b-html5-1.6.1/b-print-1.6.1/cr-1.5.2/fc-3.3.0/fh-3.1.6/kt-2.5.1/r-2.2.3/rg-1.1.1/rr-1.2.6/sc-2.0.1/sp-1.0.1/sl-1.3.1
 *
 * Included libraries:
 *  DataTables 1.10.20, AutoFill 2.3.4, Buttons 1.6.1, Column visibility 1.6.1, Flash export 1.6.1, HTML5 export 1.6.1, Print view 1.6.1, ColReorder 1.5.2, FixedColumns 3.3.0, FixedHeader 3.1.6, KeyTable 2.5.1, Responsive 2.2.3, RowGroup 1.1.1, RowReorder 1.2.6, Scroller 2.0.1, SearchPanes 1.0.1, Select 1.3.1
 */
...
(function (f) {
  ...
  q.ext = C = {
    ...
    classes: {},
    builder:
      "bs4/dt-1.10.20/af-2.3.4/b-1.6.1/b-colvis-1.6.1/b-flash-1.6.1/b-html5-1.6.1/b-print-1.6.1/cr-1.5.2/fc-3.3.0/fh-3.1.6/kt-2.5.1/r-2.2.3/rg-1.1.1/rr-1.2.6/sc-2.0.1/sp-1.0.1/sl-1.3.1",
    errMode: "alert",
    feature: [],
    search: [],
...
(function (a) {
  ...
  a.extend(m.prototype, {
    ...
    _attach: function (b) {
      ...
      c && -1 !== d.columns(this.c.columns).indexes().indexOf(c.column)
        ? (this.dom.offsetParent ||
            (this.dom.offsetParent = a(d.table().node()).offsetParent()),
          (g.height && g.width) ||
            (f.appendTo("body"),
        ...
        a.each(g, function (g, e) {
          n.append(
            a("<li/>")
              ...
              .append(
                a('<div class="dt-autofill-button">').append(
                  a(
                    '<button class="' +
                      m.classes.btn +
                      '">' +
    ...
    _drawSelection: function (b, d) {
      ...
      var e = c.row(":eq(" + g.row + ")", { page: "current" });
      ...
      if (
        ...
        g = this.dom.select;
        g.top.css({ top: c, left: b, width: f });
        g.left.css({ top: c, left: b, height: d });
        g.bottom.css({ top: c + d, left: b, width: f });
        g.right.css({ top: c, left: b + f, height: d });
      }
    },
    _editor: function (b) {
      var d = this.s.dt,
      ...
      if (c) {
        for (
          var a = {}, g = [], e = c.fields(), n = 0, h = b.length;
          n < h;
          n++
        )
    ...
    _getPosition: function (b, d) {
      ...
      do {
        ...
        if ("body" === b.nodeName.toLowerCase()) break;
        b = h.get(0);
    ...
    _mousedown: function (b) {
      ...
      this.s.start = {
        row: c
          .rows({ page: "current" })
          .nodes()
          .indexOf(a(this.dom.start).parent()[0]),
        column: a(this.dom.start).index(),
      };
      a(e.body)
        .on("mousemove.autoFill", function (b) {
          d._mousemove(b);
        })
      ...
      if (f.row !== g.row || f.column !== g.column) {
        ...
        if (a("div.DTE", h.node()).length) {
          ...
          for (
            ...
            g.push(
              a.map(f, function (b) {
                var a = c.row(":eq(" + k[p] + ")", { page: "current" });
                b = c.cell(a.index(), b + ":visible");
                a = b.data();
                var d = b.index(),
                  f = x[d.column].editField;
                f !== l &&
                  (a = m.oApi._fnGetObjectDataFn(f)(c.row(d.row).data()));
                if (-1 !== q.indexOf(d.column))
                  return { cell: b, data: a, label: b.data(), index: d };
              })
            );
    ...
    _range: function (b, a) {
      var c = [];
      if (b <= a) for (; b <= a; b++) c.push(b);
      else for (; b >= a; b--) c.push(b);
      return c;
    },
    _shiftScroll: function (b) {
      var a = this,
        c = this.s.scroll,
        f = !1,
        g = b.pageY - e.body.scrollTop,
        h = b.pageX - e.body.scrollLeft,
        n,
        k,
        l,
        m;
      ...
      null !== c.dtTop && b.pageY < c.dtTop + 65
        ? (l = -5)
        : null !== c.dtTop && b.pageY > c.dtTop + c.dtHeight - 65 && (l = 5);
      null !== c.dtLeft && b.pageX < c.dtLeft + 65
        ? (m = -5)
        : null !== c.dtLeft && b.pageX > c.dtLeft + c.dtWidth - 65 && (m = 5);
      n || k || l || m
        ? ((c.windowVert = n),
          (c.windowHoriz = k),
          (c.dtVert = l),
  ...
  m.actions = {
    ...
    fill: {
      ...
      option: function (b, a) {
        return b.i18n(
          "autoFill.fill",
          "Fill all cells with <i>" + a[0][0].label + "</i>"
        );
      },
      execute: function (b, a, c) {
        ...
        for (var d = a.length; c < d; c++)
          for (var e = 0, h = a[c].length; e < h; e++) a[c][e].set = b;
      },
    },
    fillHorizontal: {
      available: function (b, a) {
  ...
  a(e).on("preInit.dt.autofill", function (b, d, c) {
    "dt" === b.namespace &&
      ((b = d.oInit.autoFill), (c = k.defaults.autoFill), b || c) &&
      ((c = a.extend({}, b, c)), !1 !== b && new m(d, c));
  });
  k.AutoFill = m;
  return (k.AutoFill = m);
});
...
(function (b) {
  ...
  b.extend(p.prototype, {
      ...
      f.getSelection &&
        ...
        b(k).on("paste" + e, function (b) {
          ...
          !d ||
            ...
            h
              ? h.inline(d.cell.index()).set(h.displayed()[0], n).submit()
              : (d.cell.data(n), a.draw(!1)));
        }));
    },
    _columns: function () {
      var a = this.s.dt,
        ...
        if (-1 !== h.length && (a < h.start || a >= h.start + h.length))
          ...
          if (e === l || !0 === e)
            this._scroll(b(f), b(k.body), n, "offset"),
              ...
              e !== g.table().header().parentNode &&
                ((e = b(e.parentNode)), this._scroll(e, e, n, "position"));
          this.s.lastFocus = {
            cell: h,
            node: h.node(),
            relative: {
    ...
    _scroll: function (a, b, e, d) {
      ...
      a = a.width();
      "position" === d &&
        (c.top += parseInt(e.closest("table").css("top"), 10));
    ...
    _tabInput: function () {
      ...
      if (-1 != e)
        b('<div><input type="text" tabindex="' + e + '"/></div>')
          .css({
            position: "absolute",
            height: 1,
            width: 0,
  ...
  b(k).on("preInit.dt.dtk", function (a, c, e) {
    "dt" === a.namespace &&
      ((a = c.oInit.keys), (e = g.defaults.keys), a || e) &&
      ((e = b.extend({}, e, a)), !1 !== a && new p(c, e));
  });
  return p;
});
  ...
  a.extend(h.prototype, {
    ...
    _group: function (b, g) {
      for (
        ...
        l = h.row(q).data();
        l = d(l);
        if (null === l || l === e) l = this.c.emptyDataGroup;
  ...
  a.extend(m.prototype, {
    ...
    _cachePositions: function () {
      var c = this.s.dt,
        ...
        b = a.unique(c.rows({ page: "current" }).nodes().toArray()),
    ...
    _clone: function (c) {
      var e = a(this.s.dt.table().node().cloneNode(!1))
    ...
    _mouseMove: function (c) {
      ...
      if (null === this.s.lastInsert || this.s.lastInsert !== d)
        0 === d
          ...
          : ((e = a.unique(f.rows({ page: "current" }).nodes().toArray())),
            d > this.s.lastInsert
    ...
    _mouseUp: function (c) {
      ...
      var h = this.s.start.nodes,
        l = a.unique(b.rows({ page: "current" }).nodes().toArray()),
        m = {},
        q = [],
        p = [],
        r = this.s.getDataFn,
...
(function (e) {
  ...
  e.extend(g.prototype, {
    measure: function (a) {
      ...
      b.row &&
        ((b.viewport = e.contains(k, this.dom.scroller)
    ...
    _calcRowHeight: function () {
      ...
      else for (; 3 > m; m++) d.append("<tr><td>&#160;</td></tr>");
    ...
    _domain: function (a, b) {
      ...
      if ("virtualToPhysical" === a && b >= c.virtual - 1e4)
        return (a = c.virtual - b), c.scroll - a;
      if ("physicalToVirtual" === a && b >= c.scroll - 1e4)
        return (a = c.scroll - b), c.virtual - a;
  ...
  l.register(["scroller().scrollToRow()", "scroller.toPosition()"], function (
    a,
    b
  ) {
    this.iterator("table", function (c) {
  ...
  function (b) {
    function m() {
      ...
      try {
        var a = Object.seal({ x: 4 }),
          e = new b($jscomp.makeIterator([[a, "s"]]));
        if (
          "s" != e.get(a) ||
          1 != e.size ||
          e.get({ x: 4 }) ||
    ...
    h.prototype.forEach = function (a, d) {
      for (var c = this.entries(), e; !(e = c.next()).done; )
        (e = e.value), a.call(d, e[1], e[0], this);
    };
    ...
    var f = function (a, d) {
        ...
        "object" == e || "function" == e
          ? k.has(c)
            ...
            : ((e = "" + ++g), k.set(c, e), (c = e))
          : (c = "p_" + c);
        if ((e = a.data_[c]) && $jscomp.owns(a.data_, c))
...
(function () {
  var b = $.fn.dataTable,
    m = (function () {
      function f(a, d, g, c, e, r) {
        ...
        this.dom = {
          ...
          container: $("<div/>")
            ...
            .addClass(
              this.classes.layout + (7 > d ? c : c.split("-")[0] + "-6")
            ),
          ...
          dtP: $(
            "<table><thead><tr><th>" +
              (this.colExists
                ? $(a.column(this.colExists ? this.s.index : 0).header()).text()
        ...
        c = $('<button type="button">X</button>').addClass(
        ...
        this.s.searchFunction = function (a, c, d, e) {
          ...
          n.colExists &&
            ...
            "filter" !== l.orthogonal.filter &&
              ((a = n.s.rowData.filterMap.get(d)),
              a instanceof $.fn.dataTable.Api && (a = a.toArray())));
      ...
      f.prototype.destroy = function () {
        ...
        $(this.dom.container).remove();
        for (
          var a = $.fn.dataTable.ext.search.indexOf(this.s.searchFunction);
          -1 !== a;

        )
          $.fn.dataTable.ext.search.splice(a, 1),
            (a = $.fn.dataTable.ext.search.indexOf(this.s.searchFunction));
      ...
      f.prototype.updatePane = function (a) {
        void 0 === a && (a = !1);
        this.s.updating = !0;
      ...
      f.prototype._addOption = function (a, d, g, c, e, r) {
        if (Array.isArray(a) || a instanceof b.Api)
          if (
            (a instanceof b.Api && ((a = a.toArray()), (d = d.toArray())),
            a.length === d.length)
          )
            for (var f = 0; f < a.length; f++)
              r[a[f]]
                ? r[a[f]]++
                : ((r[a[f]] = 1),
                  e.push({ display: d[f], filter: a[f], sort: g, type: c }));
      ...
      f.prototype._addRow = function (a, d, g, c, e, f) {
        ...
        void 0 === r &&
          ...
          this.s.indexes.push({ filter: d, index: r }));
        return this.s.dtPane.row.add({
          display: "" !== a ? a : this.c.emptyMessage,
          filter: d,
          index: r,
          shown: g,
          sort: "" !== e ? e : this.c.emptyMessage,
          total: c,
          type: f,
        });
      };
      f.prototype._adjustTopRow = function () {
        var a = this.dom.container.find("." + this.classes.subRowsContainer),
          d = this.dom.container.find(".dtsp-subRow1"),
          g = this.dom.container.find(".dtsp-subRow2"),
          c = this.dom.container.find("." + this.classes.topRow);
        (252 > $(a[0]).width() || 252 > $(c[0]).width()) &&
        0 !== $(a[0]).width()
          ? ($(a[0]).addClass(this.classes.narrow),
            $(d[0])
          ...
          : ($(a[0]).removeClass(this.classes.narrow),
            $(d[0])
      ...
      f.prototype._buildPane = function () {
        ...
        this.selections = [];
        var d = this.s.dt,
          g = d.column(this.colExists ? this.s.index : 0),
          c = this.s.colOpts,
          e = this.s.rowData,
          r = d.i18n("searchPanes.count", "{total}"),
          f = d.i18n("searchPanes.countFiltered", "{shown} ({total})"),
          l = d.state.loaded();
        if (this.colExists) {
          var q = -1;
          if (l && l.searchPanes && l.searchPanes.panes)
            for (var p = 0; p < l.searchPanes.panes.length; p++)
              if (l.searchPanes.panes[p].id === this.s.index) {
                q = p;
                break;
              }
          if (
            (!1 === c.show || (void 0 !== c.show && !0 !== c.show)) &&
            -1 === q
          )
            return (
          ...
          if (0 === e.arrayFilter.length)
            if (
              (this._populatePane(), l && l.searchPanes && l.searchPanes.panes)
            )
              if (-1 !== q)
                (e.binsOriginal = l.searchPanes.panes[q].bins),
                  (e.arrayOriginal = l.searchPanes.panes[q].arrayFilter);
              else {
                this.dom.container.addClass(this.classes.hidden);
                this.s.displayed = !1;
                return;
          ...
          if (
            !1 === this.s.displayed &&
            ((void 0 === c.show && null === c.threshold
              ? q > this.c.threshold
              : q > c.threshold) ||
              (!0 !== c.show && 1 >= p))
          ) {
          ...
          this.c.viewTotal && 0 === e.arrayTotals.length
            ? this._detailsPane()
            : (e.binsTotal = e.bins);
              ...
              columnDefs: [
                {
                  ...
                  data: "display",
                  render: function (d, e, g) {
                    if ("sort" === e) return g.sort;
                    if ("type" === e) return g.type;
                    var b;
                    a.s.filteringActive && a.c.viewTotal
                      ? (b = f.replace(/{total}/, g.total))
                      : (b = r.replace(/{total}/, g.total));
                    for (
                      b = b.replace(/{shown}/, g.shown);
                      -1 !== b.indexOf("{total}");

                    )
                      b = b.replace(/{total}/, g.total);
                    for (; -1 !== b.indexOf("{shown}"); )
                      b = b.replace(/{shown}/, g.shown);
                    e = '<span class="' + a.classes.pill + '">' + b + "</span>";
                    if (a.c.hideCount || c.hideCount) e = "";
                    return a.c.dataLength
                  ...
                  targets: 0,
                  type:
                    void 0 !== d.settings()[0].aoColumns[this.s.index]
                      ? d.settings()[0].aoColumns[this.s.index]._sManualType
                      : null,
                },
                {
        ...
        if (this.colExists) {
          ...
          p = 0;
          for (g = e.arrayFilter.length; p < g; p++)
            !e.arrayFilter[p] ||
            (void 0 === e.bins[e.arrayFilter[p].filter] && this.c.cascadePanes)
              ? this._addRow(
                  this.c.emptyMessage,
                  k,
                  k,
              ...
              : ((q = this._addRow(
                  e.arrayFilter[p].display,
                  e.arrayFilter[p].filter,
                  e.bins[e.arrayFilter[p].filter],
                  e.binsTotal[e.arrayFilter[p].filter],
                  e.arrayFilter[p].sort,
                  e.arrayFilter[p].type
                )),
                void 0 !== c.preSelect &&
                  -1 !== c.preSelect.indexOf(e.arrayFilter[p].filter) &&
                  q.select());
        }
        (void 0 !== c.options ||
          (null !== this.customPaneSettings &&
        ...
        this.s.dt.on("stateSaveParams.dtsp", function (c, d, g) {
          if ($.isEmptyObject(g)) a.s.dtPane.state.clear();
          else {
            c = [];
        ...
        if (l && l.searchPanes && l.searchPanes.panes)
          for (
            this.c.cascadePanes || this._reloadSelect(l),
              g = 0,
              l = l.searchPanes.panes;
            g < l.length;
            g++
          )
            (p = l[g]),
              p.id === this.s.index &&
                ($(this.dom.searchBox).val(p.searchTerm),
                this.s.dt.order(p.order));
        ...
        this.s.dtPane.on("deselect.dtsp", function () {
          h = setTimeout(function () {
            ...
            0 === a.s.dtPane.rows({ selected: !0 }).data().toArray().length &&
              $(a.dom.clear).addClass(a.classes.dull);
            a._makeSelection();
            a.s.deselect = !1;
            a.s.dt.state.save();
          }, 50);
      ...
      f.prototype._displayPane = function () {
        var a = this.dom.container,
          d = this.s.colOpts,
          g = parseInt(this.c.layout.split("-")[1], 10);
        ...
        (!1 === this.c.dtOpts.searching ||
          (void 0 !== d.dtOpts && !1 === d.dtOpts.searching) ||
          !this.c.controls ||
          !d.controls ||
          (null !== this.customPaneSettings &&
            void 0 !== this.customPaneSettings.dtOpts &&
      ...
      f.prototype._findUnique = function (a, d) {
        for (var g = [], c = 0; c < d.length; c++) {
          var e = d[c];
          -1 === g.indexOf(e.filter) &&
            (a.push({
              display: e.display,
              filter: e.filter,
              sort: e.sort,
      ...
      f.prototype._getComparisonRows = function () {
        ...
        a =
          void 0 !== a.options
            ...
            : void 0;
        if (void 0 !== a) {
          var d = this.s.dt.rows({ search: "applied" }).data().toArray(),
            g = this.s.dt.rows({ search: "applied" }),
          ...
          for (var f = 0; f < a.length; f++) {
            var l = a[f],
              q = "" !== l.label ? l.label : this.c.emptyMessage,
              k = q,
              h = "function" === typeof l.value ? l.value : [],
              m = 0,
              v = q,
              u = 0;
            if ("function" === typeof l.value) {
              for (var t = 0; t < d.length; t++)
                l.value.call(this.s.dt, d[t], g[0][t]) && m++;
              for (t = 0; t < c.length; t++)
                l.value.call(this.s.dt, c[t], e[0][t]) && u++;
              "function" !== typeof h && h.push(l.filter);
            }
            (!this.c.cascadePanes || (this.c.cascadePanes && 0 !== m)) &&
              b.push(this._addRow(k, h, m, u, v, q));
          }
          return b;
        }
      };
      ...
      f.prototype._populatePane = function () {
        ...
        for (
          a =
            (!this.c.cascadePanes && !this.c.viewTotal) || this.s.clearing
              ? a.rows().indexes()
              : a.rows({ search: "applied" }).indexes();
          g < a.length;
          g++
        )
          this._populatePaneArray(a[g], this.s.rowData.arrayFilter, d);
      };
      f.prototype._populatePaneArray = function (a, d, g, c) {
        ...
        if ("string" === typeof e.orthogonal)
          (g = g.oApi._fnGetCellData(g, a, this.s.index, e.orthogonal)),
            this.s.rowData.filterMap.set(a, g),
            this._addOption(g, g, g, g, d, c);
        else {
          var b = g.oApi._fnGetCellData(
            g,
            a,
            this.s.index,
            e.orthogonal.search
          ...
          c[b]
            ...
            : ((c[b] = 1),
              this._addOption(
                b,
                g.oApi._fnGetCellData(g, a, this.s.index, e.orthogonal.display),
                g.oApi._fnGetCellData(g, a, this.s.index, e.orthogonal.sort),
                g.oApi._fnGetCellData(g, a, this.s.index, e.orthogonal.type),
                d,
                c
              ));
        }
      ...
      f.prototype._reloadSelect = function (a) {
        if (void 0 !== a) {
          for (var d, g = 0; g < a.searchPanes.panes.length; g++)
            if (a.searchPanes.panes[g].id === this.s.index) {
              d = g;
              break;
            }
          if (void 0 !== d) {
      ...
      f.prototype._search = function (a, d) {
        for (
          var g = this.s.colOpts, c = this.s.dt, e = 0, b = this.selections;
          e < b.length;
          e++
        ) {
          var f = b[e];
          if (Array.isArray(a)) {
            ...
            if (f.filter.call(c, c.row(d).data(), d)) {
              if ((this.s.redraw || this.updatePane(), "or" === g.combiner))
                return !0;
            } else {
      ...
      f.prototype._searchExtras = function () {
        ...
        var d = this.s.dtPane
            ...
            .pluck("filter")
            .toArray(),
          g = d.indexOf(this.c.emptyMessage),
          c = $(this.s.dtPane.table().container());
        -1 < g && (d[g] = "");
        0 < d.length
          ? c.addClass(this.classes.selected)
          : 0 === d.length && c.removeClass(this.classes.selected);
        this.s.updating = a;
      };
      ...
      f.prototype._updateCommon = function (a) {
        ...
        if (
          ...
          var d = this.s.colOpts,
            g = this.s.dtPane.rows({ selected: !0 }).data().toArray();
          ...
          if (
            (void 0 !== d.searchPanes && void 0 !== d.searchPanes.options) ||
            void 0 !== d.options ||
            (null !== this.customPaneSettings &&
              void 0 !== this.customPaneSettings.options)
          )
    ...
    h = (function () {
      function b(a, d, g) {
        ...
        void 0 === g && (g = !1);
        this.regenerating = !1;
        if (!k || !k.versionCheck || !k.versionCheck("1.10.0"))
          throw Error("SearchPane requires DataTables 1.10 or newer");
        ...
        this.dom = {
          clearAll: $('<button type="button">Clear All</button>').addClass(
        ...
        if (this.s.dt.settings()[0]._bInitComplete || g)
          this._paneDeclare(e, a, d);
        else
          e.on("preInit.dt", function () {
      ...
      b.prototype.rebuild = function (a) {
        ...
        for (var b = 0, c = this.s.panes; b < c.length; b++) {
          var e = c[b];
          if (!1 === a || e.s.index === a)
            e.clearData(), d.push(e.rebuildPane());
        }
      ...
      b.prototype.redrawPanes = function () {
        ...
        if (!this.s.updating) {
          var d = !0,
            b = this.s.filterPane;
          if (
            a.rows({ search: "applied" }).data().toArray().length ===
            a.rows().data().toArray().length
          )
            d = !1;
            ...
            for (var c = 0, e = this.s.panes; c < e.length; c++) {
              ...
              if (void 0 !== f.s.dtPane) {
                var n = f.s.dtPane.rows({ selected: !0 }).data().toArray()
                  .length;
          ...
          if (this.regenerating) {
            ...
            for (a = this.s.panes; c < a.length; c++)
              if (((f = a[c]), void 0 !== f.s.dtPane)) {
                e = !0;
                f.s.filteringActive = !0;
                if ((-1 !== b && null !== b && b === f.s.index) || !1 === d)
                  (e = !1), (f.s.filteringActive = !1);
                f.updatePane(e ? d : e);
              }
            this._updateFilterCount();
          } else {
            n = 0;
            for (var l = this.s.panes; n < l.length; n++)
              if (((f = l[n]), f.s.selectPresent)) {
            ...
            if (0 < this.s.selectionList.length)
              for (
                a = this.s.selectionList[this.s.selectionList.length - 1].index,
                  n = 0,
                  l = this.s.panes;
                n < l.length;
                n++
                ...
                (f = l[n]),
                  (f.s.lastSelect =
                    f.s.index === a && 1 === this.s.selectionList.length);
            for (f = 0; f < this.s.selectionList.length; f++)
              if (
                this.s.selectionList[f].index !== e ||
                !0 === this.s.selectionList[f].protect
              ) {
                a = !1;
                for (n = f + 1; n < this.s.selectionList.length; n++)
                  this.s.selectionList[n].index ===
                    this.s.selectionList[f].index && (a = !0);
                a ||
                  (c.push(this.s.selectionList[f]),
                  (this.s.selectionList[f].protect = !1));
              }
            a = 0;
            for (n = this.s.panes; a < n.length; a++)
              if (((f = n[a]), void 0 !== f.s.dtPane)) {
                e = !0;
                f.s.filteringActive = !0;
                if ((-1 !== b && null !== b && b === f.s.index) || !1 === d)
                  (e = !1), (f.s.filteringActive = !1);
            ...
            this._updateFilterCount();
            if (0 < c.length && c.length < this.s.selectionList.length)
              for (
                this._cascadeRegen(c),
                  a = c[c.length - 1].index,
                  b = 0,
                  c = this.s.panes;
                b < c.length;
                b++
              ...
              for (f = 0, c = this.s.panes; f < c.length; f++)
                if (((a = c[f]), void 0 !== a.s.dtPane)) {
                  e = !0;
                  a.s.filteringActive = !0;
                  if ((-1 !== b && null !== b && b === a.s.index) || !1 === d)
                    (e = !1), (a.s.filteringActive = !1);
                  a.updatePane(e ? d : e);
                }
          }
      ...
      b.prototype._attach = function () {
        ...
        for (var a = 0, d = this.s.panes; a < d.length; a++)
          $(d[a].dom.container).appendTo(this.dom.panes);
        $(this.dom.panes).appendTo(this.dom.container);
        0 === $("div." + this.classes.container).length &&
      ...
      b.prototype._attachPaneContainer = function () {
        for (var a = 0, d = this.s.panes; a < d.length; a++)
          if (!0 === d[a].s.displayed) return this._attach();
      ...
      b.prototype._cascadeRegen = function (a) {
        ...
        for (d = this.s.panes; a < d.length; a++)
          (e = d[a]), e.setCascadeRegen(!1);
        this.regenerating = !1;
      };
      b.prototype._checkMessage = function () {
        for (var a = 0, d = this.s.panes; a < d.length; a++)
          if (!0 === d[a].s.displayed) return;
        return this._attachMessage();
      };
              ...
              c = function (a) {
                if (a.s.index === b.index && void 0 !== a.s.dtPane) {
                  0 <
                    ...
                    void 0 !== a.s.dtPane &&
                    (a.setClear(!0), a.clearPane(), a.setClear(!1));
                  for (
                    var c = function (c) {
                        a.s.dtPane.rows().every(function (d) {
                          a.s.dtPane.row(d).data().filter === c.filter &&
                            a.s.dtPane.row(d).select();
                        });
                      },
                      d = 0,
                      f = b.rows;
      ...
      b.prototype._paneDeclare = function (a, d, b) {
        ...
        for (
          ...
          this.s.panes.push(
            new m(d, b, e + g, this.c.layout, this.dom.panes, this.c.panes[g])
          );
      ...
      b.prototype._startup = function (a) {
        ...
        this.s.dt.on("stateSaveParams.dtsp", function (a, c, b) {
          void 0 === b.searchPanes && (b.searchPanes = {});
        ...
        a.columns(0 < this.c.columns.length ? this.c.columns : void 0)
          ...
          .each(function (a) {
            if (
              void 0 !== d.s.panes[a] &&
              void 0 !== d.s.panes[a].s.dtPane &&
              void 0 !== d.s.panes[a].s.colOpts.preSelect
            )
              for (
                var c = d.s.panes[a].s.dtPane.rows().data().toArray().length,
                  b = 0;
                b < c;
                b++
              )
                -1 !==
                  d.s.panes[a].s.colOpts.preSelect.indexOf(
                    d.s.panes[a].s.dtPane.cell(b, 0).data()
                  ) &&
                  (d.s.panes[a].s.dtPane.row(b).select(),
                  d.s.panes[a].updateTable());
          });
        this._updateFilterCount();
  ...
  (function (b) {
    ...
    b(d).on("preInit.dt.dtsp", function (a, b, d) {
      "dt" === a.namespace &&
        (b.oInit.searchPanes || c.defaults.searchPanes) &&
        (b._searchPanes || f(b, !0));
    });
